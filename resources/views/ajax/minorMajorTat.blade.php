<script>
    ...
    <tr role="row">
        ...
        <button   class="btn-default btn primary"><a href="javaScript:void(0)" onclick="deleteTat({{$row->id}})"    class="btn btn-sm btn-primary" style="border-radius: 10px;"> Delete </a> </button>
        </td>
    </tr>
    @endforeach
    </tbody>
