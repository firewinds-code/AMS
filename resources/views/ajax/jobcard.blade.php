<script>
    ...
    <tr role="row">
        ...
        <button name="updateuser" id="updateuser" value="updateuser"  class="btn-default btn primary"><a href="{{route('update-case',['id' =>base64_encode($row->id)] )}}" class="btn btn-sm btn-primary" target="blank" style="border-radius: 10px;"> Click </a> </button>
        </td>
    </tr>
    {{-- @endforeach --}}
    </tbody>
