...
@section('bodycontent')
                            ...
                            <div class="tab">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 form-group">
                                                <input type="text" name="Chassis_Number_remarks"
                                                    ...
                                                    value="{{ $data[0]->Chassis_Number_remarks }}"
                                                    {{ Auth::user()->email != 'adminleyland@dispostable.com' ? 'readonly' : '' }}
                                                    placeholder="enter remarks" />
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" name="engine_no" id="engine_no"
                                                    class="form-control" value="{{ $data[0]->engine_no }}" />
                                            </div>
                                            <div class="col-md-4">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 form-group">
                                                <input type="text" name="name_of_the_insurance"
                                                    ...
                                                    value="{{ $data[0]->name_of_the_insurance }}" />
                                            </div>
                                            <div class="col-md-4 form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 form-group">
                                                <input type="text" name="customer_name_remarks"
                                                    ...
                                                    value="{{ $data[0]->customer_name_remarks }}"
                                                    placeholder="Enter remarks" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 form-group">
                                                <input type="text" name="driving_license_number"
                                                    ...
                                                    value="{{ $data[0]->driving_license_number }}"
                                                    class="form-control" />
                                            </div>
                                            <div class="col-md-4 form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 form-group">
                                                <select name="mode_of_claims" id="mode_of_claims" class="form-control"
                                                    ...
                                                    <option @if ($data[0]->mode_of_claims == 'customer') selected @endif
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-12">
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        <input type="email"
                                                            name="customer_and_accident_in_charge_email_id"
                                                            id="customer_and_accident_in_charge_email_id"
                                                            class="form-control"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        <input type="text" name="name_wkshp_dealer"
                                                            ...
                                                            value="{{ $data[0]->name_wkshp_dealer }}" />
                                                    </div>
                                                    <div class="form-group col-md-4">
                                    ...
                                    <div class="form-group col-md-6" style="border: 1px solid #ccc;">
                                        ...
                                        {{-- <div class="row">
                                            <div class="form-group col-md-12">
                                                <div class="row">
                                                    <div class="form-group col-md-4">
                                                        <label>Auto update from SAC code <span
                                                                class="text-danger">*</span></label>
                                                    </div>
                                                    <div class="form-group col-md-4">
                                                        <input type="text" name="auto_upt_sac_code"
                                                            value="{{ $data[0]->auto_upt_sac_code }}"
                                                            id="auto_upt_sac_code" class="form-control" />
                                                    </div>
                                                    <div class="form-group col-md-4">
                                                        <input type="text" name="auto_upt_sac_code_remarks"
                                                            id="auto_upt_sac_code_remarks" class="form-control"
                                                            value="{{ $data[0]->auto_upt_sac_code_remarks }}"
                                                            placeholder="Enter remarks" />
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-4 form-group">
                                                <input type="date"
                                                    {{ Auth::user()->email != 'adminleyland@dispostable.com' ? 'readonly' : '' }}
                                                    name="Job_Card_open_date" id="Job_Card_open_date"
                                                    class="form-control" value="{{ $data[0]->Job_Card_open_date }}" />
                                            </div>
                                            <div class="col-md-4 form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-3">
                                                <select name="third_party" id="third_party" class="form-control">
                                                    <option value="">--Select--</option>
                                                    <option @if ($data[0]->third_party == 'yes') selected @endif
                                                        value="yes">Yes</option>
                                                    <option @if ($data[0]->third_party == 'no') selected @endif
                                                        value="no">No</option>
                                                </select>
                                            </div>
                                            <div class="form-group col-md-1">
                                            ...
                                            <div class="form-group col-md-2">
                                                <input type="text" name="third_party_customer"
                                                    id="third_party_customer"
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-3">
                                                <select name="accident_vehicle" id="accident_vehicle"
                                                    class="form-control">
                                                    <option value="">--Select--</option>
                                                    <option @if ($data[0]->accident_vehicle == 'yes') selected @endif
                                                        value="yes">Yes</option>
                                                    <option @if ($data[0]->accident_vehicle == 'no') selected @endif
                                                        value="no">No</option>
                                                </select>
                                            </div>
                                            <div class="form-group col-md-1">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-3">
                                                <select name="Vehicle_towed" id="Vehicle_towed" class="form-control">
                                                    <option value="">--Select--</option>
                                                    <option @if ($data[0]->Vehicle_towed == 'yes') selected @endif
                                                        value="yes">Yes</option>
                                                    <option @if ($data[0]->Vehicle_towed == 'no') selected @endif
                                                        value="no">No</option>
                                                </select>
                                            </div>
                                            <div class="form-group col-md-1">
                                            ...
                                            <div class="form-group col-md-2">
                                                <input type="text" name="Vehicle_towed_dealer"
                                                    value="{{ $data[0]->Vehicle_towed_dealer }}"
                                                    id="Vehicle_towed_dealer" class="form-control" />
                                            </div>
                                            <div class="form-group col-md-1">
                                                <label>Customer</label>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-3">
                                                <select name="PA_claim" id="PA_claim" class="form-control">
                                                    <option value="">--Select--</option>
                                                    <option @if ($data[0]->PA_claim == 'yes') selected @endif
                                                        value="yes">Yes</option>
                                                    <option @if ($data[0]->PA_claim == 'no') selected @endif
                                                        value="no">No</option>
                                                </select>
                                            </div>
                                            <div class="form-group col-md-1">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-3">
                                                <select name="thermal_incident" id="thermal_incident"
                                                    class="form-control">
                                                    <option value="">--Select--</option>
                                                    <option @if ($data[0]->thermal_incident == 'yes') selected @endif
                                                        value="yes">Yes</option>
                                                    <option @if ($data[0]->thermal_incident == 'no') selected @endif
                                                        value="no">No</option>
                                                </select>
                                            </div>
                                            <div class="form-group col-md-1">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        <div class="row">
                                            <div class="form-group col-md-3">
                                                <label>What are the modification done in the vehicles</label>
                                            </div>
                                            <div class="form-group col-md-3">
                                                <input type="text" value="{{ $data[0]->theft_cases }}"
                                                    name="theft_cases" id="theft_cases" class="form-control">
                                            ...
                                            <div class="form-group col-md-2">
                                                <input type="text" name="theft_cases_customer"
                                                    value="{{ $data[0]->theft_cases_customer }}"
                                                    id="theft_cases_customer" class="form-control" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6" style="border: 1px solid #ddd;">
                                        ...
                                        <div class="row form-group" style="padding-top: 10px;">
                                            ...
                                            <div class="form-group col-md-3">
                                                <input type="text" name="Claim_Form_dealer" id="Claim_Form_dealer"
                                                    value="{{ $data[0]->Claim_Form_dealer }}"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-3">
                                                <input type="text" name="DL_remarks" id="DL_remarks"
                                                    class="form-control" value="{{ $data[0]->DL_remarks }}">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="form-group col-md-3">
                                            ...
                                            <div class="form-group col-md-3">
                                                <input type="text" name="National_Permit_remarks"
                                                    id="National_Permit_remarks" class="form-control datepickr"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-3">
                                                <input type="text" name="registration_customer"
                                                    id="registration_customer" class="form-control datepickr"
                                                    value="{{ $data[0]->registration_customer }}">
                                            </div>
                                            <div class="form-group col-md-3">
                                                <input type="text" name="registration_remarks"
                                                    id="registration_remarks" class="form-control"
                                                    value="{{ $data[0]->registration_remarks }}">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="form-group col-md-3">
                                    ...
                                    <div class="form-group col-md-6" style="border: 1px solid #ddd">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-3">
                                                <input type="text" name="load_challan_dealer"
                                                    id="load_challan_dealer"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-3">
                                                <input type="text" name="dec_letter_customer"
                                                    id="dec_letter_customer" class="form-control datepickr"
                                                    value="{{ $data[0]->dec_letter_customer }}">
                                            </div>
                                            <div class="form-group col-md-3">
                                                <input type="text" name="dec_letter_remarks"
                                                    id="dec_letter_remarks" class="form-control"
                                                    value="{{ $data[0]->dec_letter_remarks }}">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="form-group col-md-3">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-3">
                                                <input type="text" name="towing_bill_dealer"
                                                    id="towing_bill_dealer" value="{{ $data[0]->towing_bill_dealer }}"
                                                    class="form-control datepickr">
                                            </div>
                                            <div class="form-group col-md-3">
                                            ...
                                            <div class="form-group col-md-3">
                                                <input type="text" name="towing_bill_remarks"
                                                    id="towing_bill_remarks" class="form-control"
                                                    value="{{ $data[0]->towing_bill_remarks }}">
                                            </div>
                                        </div>
                                        ...
                                        {{-- <div class="row">
                                            <div class="form-group col-md-3">
                                                Motor Vehicle Inspection Report <span class="text-danger"></span>
                                            </div>
                                            <div class="form-group col-md-3">
                                                <input type="date" name="veh_ins_report_dealer"
                                                    id="veh_ins_report_dealer"
                                                    value="{{ $data[0]->veh_ins_report_dealer }}"
                                                    class="form-control">
                                            </div>
                                            <div class="form-group col-md-3">
                                                <input type="date" name="veh_ins_report_customer"
                                                    id="veh_ins_report_customer" class="form-control"
                                                    value="{{ $data[0]->veh_ins_report_customer }}">
                                            </div>
                                            <div class="form-group col-md-3">
                                                <input type="text" name="veh_ins_report_remarks"
                                                    id="veh_ins_report_remarks" class="form-control"
                                                    value="{{ $data[0]->veh_ins_report_remarks }}">
                                            </div>
                                        </div>

                                        <div class="row">
                                            <div class="form-group col-md-3">
                                                Non-Traceable Certificate <span class="text-danger"></span>
                                            </div>
                                            <div class="form-group col-md-3">
                                                <input type="date" name="non_trace_cert_dealer"
                                                    id="non_trace_cert_dealer"
                                                    value="{{ $data[0]->non_trace_cert_dealer }}"
                                                    class="form-control">
                                            </div>
                                            <div class="form-group col-md-3">
                                                <input type="date" name="non_trace_cert_customer"
                                                    id="non_trace_cert_customer" class="form-control"
                                                    value="{{ $data[0]->non_trace_cert_customer }}">
                                            </div>
                                            <div class="form-group col-md-3">
                                                <input type="text" name="non_trace_cert_remarks"
                                                    id="non_trace_cert_remarks" class="form-control"
                                                    value="{{ $data[0]->non_trace_cert_remarks }}">
                                            </div>
                                        </div> --}}
                                ...
                                <div class="tab">
                                    ...
                                    <div class="row preApproval">
                                        <div class="form-group col-md-12" id="add"
                                            ...
                                            {{-- <div class="row">
                                                    ...
                                                    <div class="form-group col-md-3">
                                                        <input type="text" name="need_to_verfy_cust" value="{{$data[0]->need_to_verfy_cust}}" id="need_to_verfy_cust" class="form-control" readonly />
                                                    </div>
                                                </div> --}}
                                            <div class="row">
                                                <div class="form-group col-md-6">
                                                ...
                                                <div class="form-group col-md-2">
                                                    <input type="text" name="initial_estimate_val_dealer_callcenter"
                                                        ...
                                                        id="initial_estimate_val_dealer_callcenter"
                                                        class="form-control" />
                                                </div>
                                                <div class="form-group col-md-2">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-2">
                                                    <input type="text"
                                                        name="surveyor_initial_inspection_dealer_remarks"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-2">
                                                    <input type="text" name="dismantling_completion_dealer"
                                                        ...
                                                        id="dismantling_completion_dealer"
                                                        class="form-control datepickr" />
                                                </div>
                                                <div class="form-group col-md-2">
                                                    <input type="text"
                                                        name="dismantling_completion_dealer_callcenter"
                                                ...
                                                <div class="form-group col-md-2">
                                                    <input type="text" name="dismantling_completion_dealer_remarks"
                                                        ...
                                                        id="dismantling_completion_dealer_remarks"
                                                        class="form-control" />
                                                </div>
                                            </div>
                                            <div class="row">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-2">
                                                    <input type="text"
                                                        name="surveyor_written_approval_dealer_callcenter"
                                                ...
                                                <div class="form-group col-md-2">
                                                    <input type="text"
                                                        name="surveyor_written_approval_dealer_remarks"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-2">
                                                    <input type="text"
                                                        name="intimation_insurance_dealer_adv_callcenter"
                                                ...
                                                <div class="form-group col-md-2">
                                                    <input type="text" name="intimation_insurance_dealer_adv_remarks"
                                                        ...
                                                        id="intimation_insurance_dealer_adv_remarks"
                                                        class="form-control" />
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-2">
                                                    <input type="text" name="mail_copy_ad_pymnt_dealer_callcenter"
                                                        ...
                                                        id="mail_copy_ad_pymnt_dealer_callcenter"
                                                        class="form-control" />
                                                </div>
                                                <div class="form-group col-md-2">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-2">
                                                    <input type="text" onchange="intemationDate(this.value)"
                                                        ...
                                                        id="Intimation_2_IC_for_surveyor_deputation"
                                                        class="form-control"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-2">
                                                    <input type="text"
                                                        name="Surveyor_initial_inspection_date_callcenter"
                                                ...
                                                <div class="col-md-2">
                                                    <input type="text"
                                                        name="Surveyor_initial_inspection_date_remarks"
                                                        id="Surveyor_initial_inspection_date_remarks"
                                                        class="form-control"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-2">
                                                    <input type="text" name="Salvage_value_agreed_by_Customer_Ins_co"
                                                        id="Salvage_value_agreed_by_Customer_Ins_co"
                                                        class="form-control"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-2">
                                                    <input type="text" onchange="writtenWork(this.value)"
                                                        ...
                                                        id="Written_work_order_approval_2_start_work"
                                                        class="form-control"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-2">
                                                    <input type="text"
                                                        name="Intimation_2_customer_for_advance_paymen"
                                                        id="Intimation_2_customer_for_advance_paymen"
                                                        class="form-control"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-2">
                                                    <input type="text"
                                                        name="Advance_payment_received_onCustomer_reason"
                                                        id="Advance_payment_received_onCustomer_reason"
                                                        class="form-control"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-2">
                                                    <input type="text"
                                                        name="Advance_payment_Value_RsCustomer_callcenter"
                                                ...
                                                <div class="col-md-2">
                                                    <input type="text"
                                                        name="Advance_payment_Value_RsCustomer_remarks"
                                                        id="Advance_payment_Value_RsCustomer_remarks"
                                                        class="form-control"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-2">
                                                    <input type="text" onchange="customerApproval(this.value)"
                                                        ...
                                                        id="Customer_written_approval_2_start_of_wor"
                                                        class="form-control"
                                    ...
                                    <div class="row repairStage">
                                        <div class="form-group col-md-12" style="border: 1px solid #ddd">
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-6">
                                                    Detail Damaged Parts List Preparation <span
                                                        class="text-danger"></span>
                                                </div>
                                                <div class="form-group col-md-2">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-2">
                                                    <input type="text" name="In_Transit_remarks"
                                                        value="{{ $data[0]->In_Transit_remarks }}"
                                                        id="In_Transit_remarks" class="form-control" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-2">
                                                    <input type="text" name="TOC_order_remarks"
                                                        value="{{ $data[0]->TOC_order_remarks }}"
                                                        id="TOC_order_remarks" class="form-control" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-2">
                                                    ...
                                                    <input type="text" name="cabin_trims_parts"
                                                        value="{{ $data[0]->cabin_trims_parts }}"
                                                        id="cabin_trims_parts" class="form-control datepickr" />
                                                </div>
                                                <div class="form-group col-md-2">
                                                    <span class="text-danger"></span>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-2">
                                                    <input type="text" name="AOR_raised_remarks"
                                                        value="{{ $data[0]->AOR_raised_remarks }}"
                                                        id="AOR_raised_remarks" class="form-control" />
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="form-group col-md-6">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-2">
                                                    <input type="text" name="receipt_all_parts"
                                                        value="{{ $data[0]->receipt_all_parts }}"
                                                        id="receipt_all_parts" class="form-control datepickr" />
                                                </div>
                                                <div class="form-group col-md-2">
                                            ...
                                            <select name="supplementary_required" id="supplementary_required"
                                                ...
                                                <option @if ($data[0]->supplementary_required == 'yes') selected @endif
                                                    value="yes">Yes</option>
                                                <option @if ($data[0]->supplementary_required == 'no') selected @endif
                                                    value="no">No</option>
                                            </select>
                                            <br>
                                            <div class="row">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-2">
                                                    <input type="text" name="supplementary_written_approval"
                                                        id="supplementary_written_approval"
                                                        class="form-control datepickr"
                                                        value="{{ $data[0]->supplementary_written_approval }}" />
                                                </div>
                                                <div class="form-group col-md-2">
                                                    <input type="text"
                                                        name="supplementary_written_approval_callcenter"
                                                        id="supplementary_written_approval_callcenter"
                                                        class="form-control"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-2">
                                                    <input type="text"
                                                        name="inform_to_customer_on_approval_callcenter"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-2">
                                                    <input type="text" name="parts_get_approval"
                                                        value="{{ $data[0]->parts_get_approval }}"
                                                        id="parts_get_approval" class="form-control datepickr" />
                                                </div>
                                                <div class="form-group col-md-2">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-2">
                                                    <input type="text" name="repair_completion"
                                                        id="repair_completion" class="form-control datepickr"
                                            ...
                                            {{-- <div class="row">
                                                <div class="col-sm-6">
                                                    <label id="startRe">Repair work start date <span
                                                            class="text-danger"></span></label>
                                                </div>
                                                <div class="col-sm-2">
                                                    <input type="text" onchange="repairStart(this.value)"
                                                        name="Repair_work_start_date" id="Repair_work_start_date"
                                                        class="form-control"
                                                        value="{{ $data[0]->Repair_work_start_date }}" />
                                                </div>
                                                <div class="col-sm-2">
                                                    <input type="text" onchange="repairStart(this.value)"
                                                        name="Repair_work_start_date_callcenter" id="Repair_work_start_date_callcenter"
                                                        class="form-control"
                                                        value="{{ $data[0]->Repair_work_start_date_callcenter }}" />
                                                </div>
                                                <div class="col-md-2">
                                                    <input type="text" name="Repair_work_start_date_reason"
                                                        id="Repair_work_start_date_reason" class="form-control"
                                                        value="{{ $data[0]->Repair_work_start_date_reason }}"
                                                        placeholder="enter reason for delay" />
                                                </div>
                                            </div> --}}
                                            ...
                                            {{-- <div class="row">
                                                <div class="col-sm-6">
                                                    <label id="repair">Repair completion date <span
                                                            class="text-danger"></span></label>
                                                </div>
                                                <div class="col-sm-2">
                                                    <input type="text" onchange="repairDate(this.value)"
                                                        name="Repair_completion_date" id="Repair_completion_date"
                                                        class="form-control"
                                                        value="{{ $data[0]->Repair_completion_date }}" />
                                                </div>
                                                <div class="col-sm-2">
                                                    <input type="text" onchange="repairDate(this.value)"
                                                        name="Repair_completion_date_callcenter" id="Repair_completion_date_callcenter"
                                                        class="form-control"
                                                        value="{{ $data[0]->Repair_completion_date_callcenter }}" />
                                                </div>
                                                <div class="col-md-2">
                                                    <input type="text" name="Repair_completion_date_reason"
                                                        id="Repair_completion_date_reason" class="form-control"
                                                        value="{{ $data[0]->Repair_completion_date_reason }}"
                                                        placeholder="enter reason for delay" />
                                                </div>
                                            </div> --}}
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    <label>Repair Overall Delay By <span
                                                            class="text-danger"></span></label>
                                                </div>
                                                <div class="col-md-6">
                                    ...
                                    <div class="row postApprovalStage">
                                        <div class="form-group col-md-12" style="border: 1px solid #ddd">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-2">
                                                    <input type="text" name="iicfi_callcenter"
                                                        id="iicfi_callcenter" class="form-control datepickr"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-2">
                                                    <input type="text" name="conduct_road_test"
                                                        value="{{ $data[0]->conduct_road_test }}"
                                                        id="conduct_road_test" class="form-control datepickr"
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-6">
                                                    Balance payment from Customer Value Rs. <span
                                                        class="text-danger"></span>
                                                </div>
                                                <div class="form-group col-md-2">
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-6">
                                                    Balance payment from Insurance Value Rs. <span
                                                        class="text-danger"></span>
                                                </div>
                                                <div class="form-group col-md-2">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-2">
                                                    <input type="text" name="gate_pass_remarks"
                                                        id="gate_pass_remarks" class="form-control"
                                                        value="{{ $data[0]->gate_pass_remarks }}" />
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-sm-6">
                                        ...
                                        <div class="form-group col-md-12" style="border: 1px solid #ddd">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-md-3">
                                                            <input type="text" name="delay_prepare_dealer_remarks"
                                                                ...
                                                                id="delay_prepare_dealer_remarks"
                                                                class="form-control" />
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-12">
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-md-3">
                                                            <input type="text"
                                                                name="surveyor_deputation_dealer_remarks"
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-12">
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-md-3">
                                                            <input type="text"
                                                                name="delay_surveyor_deputation_remarks"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-md-3">
                                                            <input type="text" name="approval_dismantling_surveyor"
                                                                ...
                                                                id="approval_dismantling_surveyor"
                                                                class="form-control" />
                                                        </div>
                                                        <div class="form-group col-md-3">
                                                            <input type="text"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-md-3">
                                                            <input type="text"
                                                                ...
                                                                id="delay_dismantling_completion"
                                                                class="form-control" />
                                                        </div>
                                                        <div class="form-group col-md-3">
                                                            <input type="text"
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-12">
                                                    <div class="row">
                                                        <div class="form-group col-md-6">
                                                            Approval delay by the customer <span
                                                                class="text-danger"></span>
                                                        </div>
                                                        <div class="form-group col-md-3">
                                                            <input type="text"
                                                                value="{{ $data[0]->approval_delay }}"
                                                        ...
                                                        <div class="form-group col-md-3">
                                                            <input type="text"
                                                                ...
                                                                name="approval_delay_remarks"
                                                                id="approval_delay_remarks" class="form-control" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-md-3">
                                                            <input type="text"
                                                                ...
                                                                id="advance_payment_delay_remarks"
                                                                class="form-control" />
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-md-3">
                                                            <input type="text"
                                                                ...
                                                                id="pre_surveyor_company_remarks"
                                                                class="form-control" />
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="form-group col-md-6" style="border: 1px solid #ddd"><br />
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-md-3">
                                                            <input type="text"
                                                                ...
                                                                name="delay_preparing_remarks"
                                                                id="delay_preparing_remarks"
                                                                class="form-control repdeanasis" />
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-12">
                                                    <div class="row">
                                                        <div class="form-group col-md-6">
                                                            No of days taken in sheet metal <span
                                                                class="text-danger"></span>
                                                        </div>
                                                        <div class="form-group col-md-3">
                                                            <input type="text"
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-12">
                                                    <div class="row">
                                                        <div class="form-group col-md-6">
                                                            No of days taken for other works <span
                                                                class="text-danger"></span>
                                                        </div>
                                                        <div class="form-group col-md-3">
                                                            <input type="text"
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-12">
                                                    <div class="row">
                                                        <div class="form-group col-md-6">
                                                            No of days taken for Painting <span
                                                                class="text-danger"></span>
                                                        </div>
                                                        <div class="form-group col-md-3">
                                                            <input type="text"
                                                                value="{{ $data[0]->no_days_taken_painting }}"
                                                                name="no_days_taken_painting"
                                                                id="no_days_taken_painting"
                                                                class="form-control repdeanasis" />
                                                        </div>
                                                        <div class="form-group col-md-3">
                                                            <input type="text"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-md-3">
                                                            <input type="text"
                                                                ...
                                                                name="delay_approval_supp_est"
                                                                id="delay_approval_supp_est"
                                                                class="form-control repdeanasis" />
                                                        </div>
                                                        <div class="form-group col-md-3">
                                                            <input type="text"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-md-3">
                                                            <input type="text"
                                                                ...
                                                                name="approval_delay_customer"
                                                                id="approval_delay_customer"
                                                                class="form-control repdeanasis" />
                                                        </div>
                                                        <div class="form-group col-md-3">
                                                            <input type="text"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-md-3">
                                                            <input type="text"
                                                                ...
                                                                name="repair_completion_bibo"
                                                                id="repair_completion_bibo"
                                                                class="form-control repdeanasis" />
                                                        </div>
                                                        <div class="form-group col-md-3">
                                                            <input type="text"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-md-3">
                                                            <input type="text"
                                                                ...
                                                                name="repaire_delay_customer"
                                                                id="repaire_delay_customer"
                                                                class="form-control repdeanasis" />
                                                        </div>
                                                        <div class="form-group col-md-3">
                                                            <input type="text"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-md-3">
                                                            <input type="text"
                                                                ...
                                                                name="delay_final_inspection"
                                                                id="delay_final_inspection"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-md-3">
                                                            <input type="text"
                                                                ...
                                                                name="delay_road_test_remarks"
                                                                id="delay_road_test_remarks"
                                                                class="form-control appsdasis" />
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-md-3">
                                                            <input type="text"
                                                                ...
                                                                name="receipt_delivery_report"
                                                                id="receipt_delivery_report"
                                                                class="form-control appsdasis" />
                                                        </div>
                                                        <div class="form-group col-md-3">
                                                            <input type="text"
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <input type="text" name="description_GIGO"
                                                            id="description_GIGO" class="form-control"
                                                            readonly="true" />
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <input type="text"
                                                            name="description_Vehicle_inward_to_out_ward"
                                                            id="description_Vehicle_inward_to_out_ward"
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            ////////////////////////Developer Devendra Yadav 04-05-2023 Description Stages///////////////////////////

            var desde = $('#pre_delay_dealer').val();
            var inform = $('#inform_to_customer_work_completed').val();
            var post = $('#post_delay_dealer').val();
            var desc_dealer = parseInt(desde) + parseInt(inform) + parseInt(post);

            $('#description_dealer').val(Math.round(desc_dealer));


            var pred = $('#pre_delay_customer').val();
            var repairec = $('#repaire_delay_customer').val();
            var postd = $('#post_delay_dealer').val();
            var desc_dealer = parseInt(pred) + parseInt(repairec) + parseInt(postd);
            $('#description_customer').val(Math.round(desc_dealer));
            ...
            var veh_rep_wkshp_dealer = new Date($('#veh_rep_wkshp_dealer').val());
            var gate_pass = new Date($('#gate_pass').val());
            ...
            var iicfi = new Date($('#conduct_road_test').val());
            var repair_completion = new Date($('#repair_completion').val());
            var conduct_road_test_diff = iicfi.getTime() - repair_completion.getTime();
            //calculate days difference by dividing total milliseconds in a day
            var conduct_road = conduct_road_test_diff / (1000 * 60 * 60 * 24);
            $('#delay_road_test').val(Math.round(conduct_road));
            ...
            var veh_delivery_customer = new Date($('#veh_delivery_customer').val());
            var veh_rep_wkshp_dealer = new Date($('#veh_rep_wkshp_dealer').val());
            ...
            $('#vehicle_inward_wards').val(Math.round(veh_rep_dealer));
            ...
            var bal_payment_customer = new Date($('#bal_payment_customer').val());
            ...
            var bal_pymnt_ins = new Date($('#bal_pymnt_ins').val());
            var receipt_delivery_order = new Date($('#receipt_delivery_order').val());
            ...
            if ((major == 'Major' && Math.round(bal_pymnty) == 0) || (major == 'Minor' && Math.round(bal_pymnty) ==
                    0)) {
            ...
            if ((major == 'Major' && Math.round(bal_pymnt) == 0) || (major == 'Minor' && Math.round(bal_pymnt) ==
                    0)) {
            ...
            var job_card_closed = new Date($('#job_card_closed').val());
            var Job_Card_open_date = new Date($('#Job_Card_open_date').val());
            ...
            var receipt_delivery_order = new Date($('#receipt_delivery_order').val());
            var proforma_submission = new Date($('#proforma_submission').val());
            ...
            var final_insption_surveyor = new Date($('#final_insption_surveyor').val());
            // var proforma_submission = new Date($('#proforma_submission').val());
            var delay_submission_invoice_diff = proforma_submission.getTime() - final_insption_surveyor.getTime();
            //calculate days difference by dividing total milliseconds in a day
            ...
            var df = $('#delay_final_inspection').val();
            var ds = $('#delay_submission_invoice').val();
            var dfds = parseInt(df) + parseInt(ds);
            $('#post_delay_dealer').val(Math.round(dfds));
            ...
            var dfd = $('#delay_road_test').val();
            var ddd = $('#delay_final_payment_customer').val();
            var dfdsd = parseInt(dfd) + parseInt(ddd);
            $('#post_delay_customer').val(Math.round(dfdsd));
            $('#post_delay_customer').attr('readonly', true);


            var delay_final = $('#delay_final_inspection_surveyor').val();
            var receipt = $('#receipt_delivery_report').val();
            var insurance = $('#delay_final_payment_insurance').val();
            ...
            ////////////////////////Developer Devendra Yadav 04-05-2023 Post Stages///////////////////////////

            ////////////////////////Developer Devendra Yadav 04-05-2023 Repair Stages///////////////////////////

            var initial_estimate_dealer_date1 = new Date($('#apc_time_dealer').val());
            var initial_estimate_dealer_date2 = new Date($('#repair_work_start_dealer').val());
            ...
            var initial_estimate_dealer_date1 = new Date($('#detail_damaged_dealer').val());
            var detail_damaged_dealer_diff = initial_estimate_dealer_date1.getTime() - initial_estimate_dealer_date2
                .getTime();
            //calculate days difference by dividing total milliseconds in a day
            ...
            if ((major == 'Major' && detail_damaged_dealer <= 2) || (major == 'Minor' && detail_damaged_dealer <=
                    1)) {
            ...
            var sheet_denting_repair1 = new Date($('#sheet_denting_repair').val());
            var sheet_denting_repair2 = new Date($('#sheet_denting_repair_remarks').val());
            ...
            if ((major == 'Major' && sheet_denting_repai <= 5) || (major == 'Minor' && sheet_denting_repai <= 3)) {
            ...
            var mech_elec_repair = new Date($('#mech_elec_repair').val());
            var mech_elec_repair_remarks = new Date($('#mech_elec_repair_remarks').val());
            ...
            var painting_start = new Date($('#painting_start').val());
            var painting_start_remarks = new Date($('#painting_start_remarks').val());
            ...
            var cabin_trims_parts = new Date($('#cabin_trims_parts').val());
            var cabin_trims_parts_remarks = new Date($('#cabin_trims_parts_remarks').val());
            ...
            var receipt_all_parts = new Date($('#receipt_all_parts').val());
            var AOR_raised = new Date($('#AOR_raised').val());
            ...
            var outside_job = new Date($('#outside_job').val());
            var outside_job_remarks = new Date($('#outside_job_remarks').val());
            ...
            var parts_get_approval = new Date($('#intimation_surveyor').val());
            var Repair_work_start_date = new Date($('#repair_work_start_dealer').val());
            ...
            var supplementary_inspection = new Date($('#supplementary_inspection').val());
            var intimation_surveyor = new Date($('#intimation_surveyor').val());
            ...
            var supplementary_written_approval = new Date($('#supplementary_written_approval').val());
            // var supplementary_inspection = new Date($('#supplementary_inspection').val());
            var delay_approval_supp_est_dif = supplementary_written_approval.getTime() - supplementary_inspection
                .getTime();
            //calculate days difference by dividing total milliseconds in a day
            ...
            var parts_get = new Date($('#parts_get_approval').val());
            ...
            //    var gg = $('#repair_receipt_all_parts');
            var hh = $('#delay_supp_estimate').val();
            var ii = $('#repair_completion_bibo').val();

            var dealer_repair = parseInt(aa) + parseInt(bb) + parseInt(cc) + parseInt(dd) + parseInt(ee) + parseInt(
                ff) + parseInt(hh) + parseInt(ii);


            var approval_delay_customer = $('#approval_delay_customer').val();

            var supaa = $('#delay_report_workshop').val();
            var supbb = $('#delay_approval_supp_est').val();

            var sup_repair = parseInt(supaa) + parseInt(supbb);

            $('#inform_to_customer_work_completed').val(dealer_repair);
            $('#inform_to_customer_work_completed').attr('readonly', true);

            $('#repaire_delay_customer').val(approval_delay_customer);
            $('#repaire_delay_customer').attr('readonly', true);

            $('#repaire_surveyor_company').val(sup_repair);
            $('#repaire_surveyor_company').attr('readonly', true);


            ////////////////////////Developer Devendra Yadav 04-05-2023 Pre Stages///////////////////////////
            var major = $('#major_minor_dealer').val();
            var initial_estimate_dealer_date1 = new Date($('#Job_Card_open_date').val());
            var initial_estimate_dealer_date2 = new Date($('#initial_estimate_dealer').val());
            ...
            var mailcopy = new Date($('#mail_copy_dealer').val());
            ...
            var surveyor_initial_inspection_dealer = new Date($('#surveyor_initial_inspection_dealer').val());
            var intimation_insurance_dealer = new Date($('#intimation_insurance_dealer').val());
            var delay_deputation_diff = surveyor_initial_inspection_dealer.getTime() - intimation_insurance_dealer
                .getTime();
            ...
            var dismanting = new Date($('#approval_dismantling_dealer').val());
            var inspectDealer = new Date($('#surveyor_initial_inspection_dealer').val());
            ...
            var dismantling_completion_dealer = new Date($('#dismantling_completion_dealer').val());
            var approval_dismantling_dealer = new Date($('#approval_dismantling_dealer').val());
            ...
            var intimation_surveyor_dealer = new Date($('#intimation_surveyor_dealer').val());
            var intimation_surveyor_dealer_diff = dismantling_completion_dealer.getTime() -
                intimation_surveyor_dealer.getTime();
            var intimation_to_surveyor_for_second_inspection = intimation_surveyor_dealer_diff / (1000 * 60 * 60 *
                24);
            ...
            var surveyor_second_dealer = new Date($('#surveyor_second_dealer').val());
            ...
            var surveyor_written_approval_dealer = new Date($('#surveyor_written_approval_dealer').val());
            ...
            var parts_approved_dealer = new Date($('#parts_approved_dealer').val());
            ...
            var customer_approval_dealer = new Date($('#customer_approval_dealer').val());
            var apc_time_dealer = new Date($('#apc_time_dealer').val());
            ...
            if ((major == 'Major' && advance_payment_delay <= 1) || (major == 'Minor' && advance_payment_delay <=
                    0)) {
            ...
            var mail_copy_ad_pymnt_dealer = new Date($('#mail_copy_ad_pymnt_dealer').val());
            var surveyor_written_approval_dealer = new Date($('#surveyor_written_approval_dealer').val());
            ...
            var api_time_dealer = new Date($('#api_time_dealer').val());
            var intimation_insurance_dealer_adv = new Date($('#intimation_insurance_dealer_adv').val());
            ...
            let x = $('#delay_prepare_dealer').val();
            let y = $('#surveyor_deputation_dealer').val();
            let z = $('#delay_dismantling_completion').val();
            let zz = $('#intimation_to_surveyor_for_second_inspection').val();
            let dealer = parseInt(x) + parseInt(y) + parseInt(z) + parseInt(zz);
            $('#pre_delay_dealer').val(Math.round(dealer));
            ...
            //let cz =  $('#delay_dismantling_completion').val();
            //let czz =  $('#intimation_to_surveyor_for_second_inspection').val();
            let customer = parseInt(cx) + parseInt(cy);
            $('#pre_delay_customer').val(Math.round(customer));
            ...
            $('#pre_surveyor_company').val(Math.round(supervisor));
            $('#pre_surveyor_company').attr('readonly', true);


            ////////////////////////Developer Devendra Yadav 04-05-2023///////////////////////////
        ...
        function changeAcc(slug) {
            ...
            var intemationdate = new Date($('#Intimation_2_IC_for_surveyor_deputation').val());
        ...
        function advancePayment(advancePayment) {
            var jobCard = $('#Job_Card_open_date').val();
            var slug = $('#Major_Minor__Final_bill').val();
            var date1 = new Date(jobCard);
        ...
        function checkAll() {
            ...
            if (Mode_of_Claim == 'Customer') {
                ...
                if (Intimation_2_customer_for_advance_paymen == '' || Advance_payment_received_onCustomer == '' ||
                    ...
                    $('#Completed').show();
                    // $('#case_status').append("<option value='Completed' "{{ $data[0]->case_status == 'Completed' ? 'selected' : '' }}">Completed</option>");
                }
        ...
        function stageFun(param) {
            ...
            /* if(val == 'Repair stage' && (Repair_work_start_date =='' || Repair_work_start_date =='NA' )){
                alert("Repair work start date should not be blank");
                $('#Repair_work_start_date').focus();
                $('#stage').val('');
            }else if(val == 'Post Approval stage') {
                if(Repair_work_start_date =='' || Repair_work_start_date =='NA' ){
                    alert("Repair work start date should not be blank");
                    $('#Repair_work_start_date').focus();
                    $('#stage').val('');
                }else if(Repair_completion_date =='' || Repair_completion_date =='NA' ){
                    alert("Repair completion date should not be blank");
                    $('#Repair_completion_date').focus();
                    $('#stage').val('');
                }
            } */
            var ell = '';
